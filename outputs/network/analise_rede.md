...
A rede é uma **projeção bipartite**: cada stakeholder externo recebe uma aresta ponderada para cada um dos 4 parceiros MBO se o alinhamento temático/territorial passar de um limiar. Não há ligações diretas entre stakeholders externos. A leitura visual privilegia o papel de cada um *em relação aos parceiros*.
...
|---|---|---|
| Bioma primário coincide | +3 | diferenciador territorial mais forte |
| Bioma secundário coincide | +1 | — |
| Impact area coincide | +1 | peso baixo: 244/360 têm "Land, Food and Forest" |
| Role coincide (até 2) | +0,5/match | cap 1,0 |
| Keywords específicas (até 4) | +2/keyword | cap 8 — principal diferenciador |
| Alcance nacional | +0,5 | — |

**Limiar para conexão**: score ≥ 4.5.


**Gates**

- *Amazônico* — para UNICAFES PA/RO, sem bioma amazônica nem keyword amazônica o score zera. Evita falsos positivos com organizações nacionais broad-spectrum.
- *Catadores* — para UNICATADORES, exige pelo menos uma keyword de resíduo, catador, circular ou PNRS.
...
- **CSOs dominam** (128 / 360, 35,6%), seguidas por categoria "Others" (73) — que inclui organizações com classificação dupla ou atípica como UNICATADORES e movimentos sociais.
- A **filantropia institucional** é o segundo maior pool (49 fundações + 30 alianças/iniciativas multistakeholder).
- O setor privado mapeado tem **43 grandes empresas** vs. apenas 11 investidores de impacto e 4-5 SMEs — o ecossistema retratado privilegia o corporate, não o tecido empreendedor de pequeno e médio porte.
- **Amazônia concentra o maior número de atores temáticos** (105 / 360, 29%), mas Cerrado (78) e Caatinga (54) também têm presença significativa. Mata Atlântica, Pantanal, Pampa e Costeiro/marinho aparecem predominantemente como biomas secundários.
- A **arquitetura de financiamento** é fortemente assimétrica: 198 grantees, 116 doadores, 37 regranters. A relação 1:5 entre regranter e grantees indica que a maior parte da captação se dá por relação direta doador→grantee, com pouco papel intermediário formal.
...
- **União Nacional de Cooperativas da Agricultura Familiar e Economia Solidária (Unicafes)** (Grassroots networks) — UNICAFES Pará · UNICAFES Rondônia · CSA Brasil
- **Instituto Ouro Verde (IOV)** (Local implementers) — UNICAFES Pará · UNICAFES Rondônia · CSA Brasil
- **Instituto Conexões Sustentáveis (Conexsus)** (Local implementers) — UNICAFES Pará · UNICAFES Rondônia · CSA Brasil
- **Movimento dos Trabalhadores Rurais Sem Terra (MST)** (Social moviments) — UNICAFES Pará · UNICAFES Rondônia · CSA Brasil
- **Movimento dos Pequenos Agricultores (MPA)** (Social moviments) — UNICAFES Pará · UNICAFES Rondônia · CSA Brasil
- **Centro Internacional de Pesquisa Florestal e Agroflorestal (CIFOR-ICRAF)** (Monitoring, Evaluation, and Learning) — UNICAFES Pará · UNICAFES Rondônia · CSA Brasil
- **Articulação dos Povos Indígenas do Brasil (APIB)** (Grassroots networks) — UNICAFES Pará · UNICAFES Rondônia · CSA Brasil
- **Instituto de Pesquisa Ambiental da Amazônia (IPAM)** (Monitoring, Evaluation, and Learning) — UNICAFES Pará · UNICAFES Rondônia · CSA Brasil
- **Instituto Ibirapitanga** (Philanthropy foundations) — UNICAFES Pará · UNICAFES Rondônia · CSA Brasil
- **Instituto Centro de Vida (ICV)** (Monitoring, Evaluation, and Learning) — UNICAFES Pará · UNICAFES Rondônia · CSA Brasil

### Bridges duplas — destaques

- **Articulação Nacional de Agroecologia (ANA)** (Grassroots networks) — UNICAFES Pará · CSA Brasil
- **Movimento de Mulheres Camponesas (MMC)** (Social moviments) — UNICAFES Pará · CSA Brasil
- **Natura** (Private companies (large / leading)) — UNICAFES Rondônia · CSA Brasil
- **Instituto Arapyaú** (Philanthropy foundations) — UNICAFES Pará · UNICAFES Rondônia
- **Vale S.A.** (Private companies (large / leading)) — UNICAFES Rondônia · CSA Brasil
- **Suzano S.A.** (Private companies (large / leading)) — UNICAFES Rondônia · CSA Brasil
- **Banco da Amazônia S.A. (BASA)** (Development banks) — UNICAFES Pará · UNICAFES Rondônia
- **Manioca** (Private companies (SMEs / local enterprises)) — UNICAFES Pará · UNICAFES Rondônia
...
- Serviço Florestal Brasileiro (SFB) (Monitoring, Evaluation, and Learning)
...
**(b) Concentração da filantropia no eixo Rio-São Paulo.** A maioria das fundações e regranters mapeados tem sede em RJ ou SP. Para uma operação centrada na Amazônia rural, a captação local (BASA, Banco do Brasil, governos estaduais do Pará/Rondônia, FAPESP amazônica) aparece sub-representada no mapeamento e merece complementação.

**(c) Setor privado: grandes empresas vs. negócios de impacto.** Há 43 grandes empresas vs. 11 impact investors e poucos SMEs. Para o objetivo de fortalecer cadeias de valor da sociobiodiversidade e economia circular, o ecossistema retratado privilegia parceiros B2B de grande porte (Natura, Suzano, Vale, Colruyt) — útil para off-take agreements, mas insuficiente para construir um tecido de fornecedores intermediários. AMAZ, Yunus, ICE e iniciativas como o Sebrae merecem reforço.

**(d) Academia e dados.** WRI Brasil, IPAM, ICV, CPI, Earth Innovation, Agroicone e INPE aparecem como bridges para os parceiros amazônicos — uma força do ecossistema. A integração entre esses centros e os parceiros MBO é, na prática, uma das maiores alavancas para evidência, MRV e advocacy baseada em dados.
...
**Para identificar parceiros prioritários de articulação.** Os bridges (seção 4) são os candidatos naturais para o papel de hub que a Trias quer ocupar — articulação com 1 deles propaga para 2-3 parceiros MBO. Tri-bridges merecem entrevista qualitativa antes do início do ciclo.

**Para sustentabilidade pós-2031.** A seção 6 indica onde o ecossistema é frágil (UNICATADORES isolado, captação local sub-representada, baixa densidade de impact investors) — informação que alimenta a estratégia de saída (Lacuna 4 do Diagnóstico Técnico).
